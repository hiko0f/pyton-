...
def add_passenger(self, human):
 ...
 def print_passengers_names(self):
     ...
     for passenger in self.passengers:
         ...
         print(f"There are no passengers")
     in {self.brand}
                         ...
                         def shopping(self, manage):
                             ...
                             def to_repair(self):
                                 ...
                                 def days_indexes(self, day):
                                     ...
                                     print(f"Strength – {self.car.strength}")def is_alive(self):
 if self.gladness<0:
 print("Depression…")
 return False
 if self.satiety<0:
...
if self.home is None:
 ...
 if self.job is None:
 self.get_job()
 print(f"I don't have a job, I'm going
 to get a job {self.job.job} with
